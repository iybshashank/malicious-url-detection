...
# UNIQUE DOMAIN, SUBDOMAIN AND DOMAIN SUFFIX THAT HAVE BEEN EXTRACTED
...
#PLOTTING OTHER FEATURES LINKE SUBDOMAIN& DOMAIN SUFFIX
plot(
...
history = model.fit(train_x, train_y, batch_size=64, verbose=1, epochs=25, validation_split=0.2, shuffle=True, callbacks=early_stopping)
model.save('model.h5')
